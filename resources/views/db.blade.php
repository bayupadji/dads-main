                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Jumlah Pengunjung</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dp->no_hp}}</td>
                                        <td>{{$dp->tiket}}</td>
                                        <td>{{Carbon::parse($dp->tanggal)->format('d-m-Y');}}</td>
                                        <td>{{$dp->harga}}</td>
                                        <td>
                                            <a href="/dashboard/invoice/pdf/{{$dp->id}}" target="__blank" class="btn btn-sm btn-info">PDF</a>
                                            <a href="/dashboard/edit/{{$dp->id}}" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="/dashboard/delete/{{$dp->id}}" class="btn btn-sm btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
